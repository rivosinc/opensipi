...
def generate_apply_stackup_tcl(sim_info):
    ...
    try:
        with open(tcl_file_path, "w", encoding="utf-8") as file:
            ...
            file.write(r"#==================OPEN PowerDC before running scripts===========" + "\n")
            file.write(r"sigrity::open document {!}" + "\n")

            file.write(r"#==================applying some powerDC sim settings============" + "\n")
            ...
            if os.path.exists(stackupfile_path):
                file.write(r"#==================apply stackup and material================" + "\n")
            ...
            file.write(r"#==================save spd file and results file================" + "\n")
...
def generate_single_ir_tcl(sim_info):
    ...
    try:
        with open(sim_info["DNS_list_file"], encoding="utf-8") as f:
    ...
    try:
        with open(tcl_file_path, "w", encoding="utf-8") as file:
            ...
            file.write(r"#==================setup simulation mode to IRdrop===============" + "\n")
            file.write(r"sigrity::set pdcSimMode -irDropAnalysis {1}" + "\n")

            file.write(r"#==================update max via current to 0.25 ===============" + "\n")
            ...
            file.write(r"#==================delete area based on enabled nets==============" + "\n")
...
def generate_single_resmeas_tcl(sim_info):
    ...
    try:
        with open(tcl_file_path, "w", encoding="utf-8") as file:
            ...
            file.write(r"#=======setup simulation mode to resistance measurement==========" + "\n")
            file.write(
                r"sigrity::update workflow -product {PowerDC} -workflowkey "
    ...
    try:
        with open(tcl_file_path, "w", encoding="utf-8") as file:
            ...
            for key in brd_path.keys():
                ...
                try:
                    with open(sim_info["list_DNS_files"][key], encoding="utf-8") as f:
                        dns_list_ = f.readline()
                        if dns_list_ != "":
                            dns_list = dns_list_.replace(";", " ").rstrip()
                            file.write(r"# Disable DNS components" + "\n")
            ...
            file.write(r"#==================setup and save multibrd_workspace=======" + "\n")
            file.write(
            ...
            file.write(r"#============save workspace file and results file==========" + "\n")
